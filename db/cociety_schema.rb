...
ActiveRecord::Schema.define(version: 20_210_107_212_934) do
  ...
  create_table 'external_entities', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[external_entity_source_id internal_entity_type internal_entity_id],
            name: 'index-entity_id-internal-type_internal-id'
    t.index ['external_entity_source_id'], name: 'index_external_entities_on_external_entity_source_id'
    t.index %w[internal_entity_type internal_entity_id], name: 'index_type_id'
  end
  ...
  create_table 'external_events', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[external_entity_source_id external_id], name: 'index-external_source-external_id'
  ...
  create_table 'organization_categories_organizations', id: false, force: :cascade do |t|
    ...
    t.index %w[organization_category_id organization_id], name: 'category_to_organizations', unique: true
    t.index %w[organization_id organization_category_id], name: 'organization_to_categories', unique: true
  end
